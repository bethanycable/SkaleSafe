...
const Features = () => {
  ...
  const features__items_start = "flex flex-col items-center justify-center text-justify ml:flex ml:flex-row ml:self-start gap-y-4 ml:gap-y-8"
  const features__items_end = "flex flex-col items-center justify-center text-justify ml:flex ml:flex-row ml:self-end gap-y-4 ml:gap-y-8"
  const features__videos = "order-first w-5/6 ml:w-2/3 max-w-lg"
  return (
    <div
      id="features"
      className="h-fit w-screen py-10 ml:py-20 bg-gradient-to-tl from-teal-blue"
    >
      <h1  
        className="text-center text-3xl ml:text-4xl text-honeydew font-bold uppercase tracking-wider underline underline-offset-8 decoration-4 ml:mt-5 mb-10 ml:mb-20"
      >
        Features
      </h1>
      <div className="flex flex-col items-center gap-4 ml:gap-6 gap-y-12 ml:gap-y-20 text-honeydew text-md lg:text-xl mx-6 ml:mx-20">
